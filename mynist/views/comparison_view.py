...
# Note: Les classes AnnotationPoint, CalibrationPoint, MeasurementLine et AnnotatableView
# sont maintenant définies dans mynist.views.comparison.annotatable_view
